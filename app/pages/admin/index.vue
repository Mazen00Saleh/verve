<template>
  <div>
    ...
    <p class="mt-3 max-w-2xl text-sm font-normal text-luxury-charcoal">
    ...
    <div class="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
      ...
      >
        ...
        <p class="mt-2 text-sm font-normal text-luxury-charcoal">{{ item.description }}</p>
      </NuxtLink>
    </div>
  </div>
</template>
...
const quickLinks = [
  {
    label: 'Categories',
    to: '/admin/categories',
    description: 'Manage product categories shown on the public site.',
  },
  {
    label: 'Collections',
    to: '/admin/collections',
    description: 'Organize collections within each category.',
  },
  {
    label: 'Products',
    to: '/admin/products',
    description: 'Create and update individual product entries.',
  },
  {
    label: 'Brochures',
    to: '/admin/brochures',
