<template>
  <div>
    ...
    <div v-if="loading" class="text-sm text-luxury-charcoal">Loading messages...</div>

    <div v-else-if="!submissions.length" class="border border-dashed border-neutral-300 bg-white p-10 text-center text-sm text-luxury-charcoal">
...
const { fetchAll, updateStatus, loading } = useContactSubmissions()
...
async function loadSubmissions() {
  submissions.value = await fetchAll()
}
